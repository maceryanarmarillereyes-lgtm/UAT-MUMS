/* @AI_CRITICAL_GUARD: Release Notes Route — /api/settings/release_notes
   GET:  Any authenticated user — returns list of release notes
   POST: SUPER_ADMIN only — publish a new release note (HTML content + metadata)
   DELETE: SUPER_ADMIN only — remove a release note by id */
