/**
 * @file config.js
 * @description Global application configuration: roles, teams, schedules, themes, navigation, permissions
 * @module MUMS/Config
 * @version UAT
 */
    ...
    NAV: [
      ...
      // SYSTEM MENU — Super Admin only (infrastructure monitoring & diagnostics)
      {
        ...
        children: [
          ...
          { id: 'system_analytics',   label: 'Analytics',            icon: '📈', perm: 'system_monitor' },
        ]
      },
    ],
