...
async function getRoutes(env) {
  ...
  ROUTES = {
    ...
    'auth/password_login': unwrapCjs(await import('../../server/routes/auth/password_login.js')),
    ...
    'catalog/comments': unwrapCjs(await import('../../server/routes/catalog/comments.js')),
